...
// -------------
//
// * browser - The default target. This will package up the core
//             `highlight.js` along with all the language definitions into
//             the file `highlight.pack.js` -- which will be compressed
//             without including the option to disable it. It also builds
//             the documentation for our readthedocs page, mentioned above,
//             along with a local instance of the demo at:
//
//             <https://highlightjs.org/static/demo/>.
//
// * cdn - This will package up the core `highlight.js` along with all the
//         language definitions into the file `highlight.min.js` and
//         compresses all languages and styles into separate files. Since
//         the target is for CDNs -- like cdnjs and jsdelivr -- it doesn't
//         matter if you put the option to disable compression, this target
//         is always be compressed. Do keep in mind that we don't keep the
//         build results in the main repository; however, there is a
//         separate repository for those that want the CDN builds without
//         using a third party site or building it themselves. For those
//         curious, head over to:
//
//         <https://github.com/highlightjs/cdn-release>
//
// * node - This build will transform the library into a CommonJS module. It
