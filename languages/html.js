...
LANGUAGES.django = {
  ...
  modes: [
    ...
    },
    {
      ...
      begin: '\\{\\%', end: '\\%\\}',
      lexems: [IDENT_RE],
      keywords: {'comment': 1, 'load': 1, 'templatetag': 1, 'ifchanged': 1, 'if': 1, 'firstof': 1, 'for': 1, 'in': 1, 'ifnotequal': 1, 'widthratio': 1, 'extends': 1, 'include': 1, 'spaceless': 1, 'regroup': 1, 'by': 1, 'as': 1, 'ifequal': 1, 'ssi': 1, 'now': 1, 'with': 1, 'cycle': 1, 'url': 1, 'filter': 1, 'debug': 1, 'block': 1},
      contains: ['filter']
    },
    {
      className: 'variable',
