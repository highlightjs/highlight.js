...
дальше раздел "Эвристика").


## Простое использование

Подключите библиотеку и стиль на страницу и повесьте вызов подсветки на
загрузку страницы:
...
подсвечивать блоки кода динамически, читайте раздел "Инициализацию вручную" ниже.
...
## Замена символов табуляции (TABов)

Вы можете заменить символы TAB ('\x09'), используемые для отступов,
на фиксированное количество пробелов или отдельный `<span>`,
...
Если вы используете другие теги для блоков кода, их можно раскрасить
явно с помощью функции `highlightBlock(code)`.
Она принимает DOM-элемент с текстом расцвечиваемого кода.
...
Это может понадобиться, например, на сайте, на котором нельзя подключить сам скрипт
highlight.js.
