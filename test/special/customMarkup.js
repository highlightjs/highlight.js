...
describe('custom markup', function() {
  before(function() {
    let testHTML = document.querySelectorAll('#custom-markup .hljs');

    this.blocks = _.map(testHTML, 'innerHTML');
  });

  it('should replace tabs', function() {
    let filename = utility.buildPath('fixtures', 'expect', 'tabreplace.txt'),
  ...
  it('should keep custom markup', function() {
    let filename = utility.buildPath('fixtures', 'expect', 'custommarkup.txt'),
  ...
  it('should keep custom markup and replace tabs', function() {
    let filename = utility.buildPath('fixtures', 'expect', 'customtabreplace.txt'),
  ...
  it('should keep the same amount of void elements (<br>, <hr>, ...)', function() {
    let filename = utility.buildPath('fixtures', 'expect', 'brInPre.txt'),
