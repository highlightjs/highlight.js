...
<!-- LANGLIST -->
| Language                | Aliases                | Package | Common |
| :-----------------------| :--------------------- | :------ | :----- |
| 1C                      | 1c                     |         | |
...
| HTML, XML               | xml, html, xhtml, rss, atom, xjb, xsd, xsl, plist, svg | | X |
| HTTP                    | http, https            |         | |
| Hy                      | hy, hylang             |         | |
| Inform7                 | inform7, i7            |         | |
| Ini, TOML               | ini, toml              |         | X |
...
| Makefile                | makefile, mk, mak, make |        | X |
| Markdown                | markdown, md, mkdown, mkd |      | X |
...
| Objective C             | objectivec, mm, objc, obj-c, obj-c++, objective-c++ |    | X |
| OCaml                   | ocaml, ml              |         | |
...
| Plaintext               | plaintext, txt, text   |         | X |
| Pony                    | pony                   |         | |
...
| Puppet                  | puppet, pp             |         | |
| Python                  | python, py, gyp        |         | X |
| Python profiler results | profile                |         | |
| Python REPL             | python-repl, pycon     |         | X |
| Q                       | k, kdb                 |         | |
...
| Ruby                    | ruby, rb, gemspec, podspec, thor, irb | | X |
| Rust                    | rust, rs               |         | X |
...
| Twig                    | twig, craftcms         |         | |
| TypeScript              | typescript, ts, tsx, mts, cts |         | X |
