...
Автоопределение языка можно запретить, когда оно не справляется (см. 
дальше "Эвристика").
...
языков много. Чтобы ускорить процесс, можно перечислить в вызове
функции initHighlighting только те языки, которые используются:
