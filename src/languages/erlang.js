...
BASIC_MODES = ['comment', 'named_fun', 'block_statements', 'function_call', 'atom', 'string', 'number', 'tuple', 'variable', 'record_access']
...
className: 'comment',
    ...
    { 
    className: 'variable',
    //displayClassName: 'unused_variable',
    ...
    //contains: BASIC_MODES
    //contains: ['block_statements', 'function_call', 'record_access', 'tuple', 'variable', 'number', 'string']
