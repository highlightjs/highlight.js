...
export default function(hljs) {
    return {
        name: 'MKB',
        keywords: ' ACHIEVEMENTGET ARRAYSIZE ASSIGN BIND BINDGUI BREAK CALCYAWTO CAMERA CHATFILTER' +
            ...
            ' Events onArmourChange onArmourDurabilityChange onAutoCraftingComplete onChat onConfigChange' +
            ...
            ' Iterators controls effects enchantments env players properties running' +
            ' Parameters $$! $$? $$[[array,of,things]] $$[name] $$<file.txt> $$0-9 $$d $$f $$h $$i $$i:d' +
            ' $$k $$m $$p $$pn $$px $$py $$pz $$s $$t $$u $$w' +
            ' REPL Commands BEGIN CAT CLS EDIT END EXIT EXPAND HELP KILL LIST LIVE RM RUN SAY SHUTDOWN' +
            ' TASKS VERSION WHOAMI' +
            ' Variables ~ALT ~CTRL ~KEY_<name> ~KEY_0 ~KEY_1 ~KEY_2 ~KEY_3 ~KEY_4 ~KEY_5 ~KEY_6 ~KEY_7' +
