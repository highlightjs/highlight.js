...
export default function(hljs) {
  ...
  var FILTER = {
    ...
    keywords:
      ...
      'length locale_name lower map markdown_to_html merge nl2br number_format raw reduce replace ' +
      'reverse round slice sort spaceless split striptags timezone_name title trim u|0 upper url_encode',
    contains: [
      FUNCTIONS
    ]
  };
