...
function(hljs) {
  var KEYWORDS = {
    keyword:  'module use_module import_module' + ' ' +
              'include_module end_module' + ' ' +
              'initialise mutable' + ' ' +
              ...
              'pragma promise external' + ' ' +
              'trace atomic or_else' + ' ' +
              'require_complete_switch' + ' ' +
              'require_det require_semidet require_multi' + ' ' +
              'require_nondet require_cc_multi require_cc_nondet' + ' ' +
              'require_erroneous require_failure',

    pragma:   'inline no_inline' + ' ' +
              'type_spec source_file fact_table obsolete' + ' ' +
              'memo loop_check minimal_model' + ' ' +
              'terminates does_not_terminate check_termination' + ' ' +
              'promise_equivalent_clauses',

    preprocessor: 'foreign_proc foreign_decl foreign_code' + ' ' +
                  'foreign_type foreign_import_module' + ' ' +
                  'foreign_export_enum foreign_export' + ' ' +
                  'foreign_enum' + ' ' +
                  ...
                  'affects_liveness' + ' ' +
                  'does_not_affect_liveness doesnt_affect_liveness' + ' ' +
                  'no_sharing unknown_sharing sharing',
  ...
  var NUMBER = hljs.inherit(hljs.NUMBER_MODE);
