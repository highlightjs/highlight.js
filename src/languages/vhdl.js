    ...
    defaultMode: {
      keywords: {
        'keyword': {
            ...
            'disconnect': 2,        'downto': 2,            'default': 1,
            'else': 1,              'elsif': 1,             'end': 1,
            'entity': 2,            'exit': 1,              'fairness': 1,
            'file': 1,              'for': 1,               'force': 1,
            'function': 1,          'generate': 2,          'generic': 2,
            'group': 1,             'guarded': 2,           'if': 0,
            'impure': 2,            'in': 1,                'inertial': 1,
            ...
            'of': 1,                'on': 1,                'open': 1,
            'or': 1,                'others': 1,            'out': 1,
            'package': 1,           'port': 2,              'postponed': 1,
            'procedure': 1,         'process': 1,           'property': 1,
            'protected':1,          'pure': 2,              'range': 1,
        ...
        'typename': {
            ...
            'severity_level': 2,    'integer': 1,           'time': 1,
            'delay_length': 2,      'natural': 1,           'positive': 1,
            'string': 1,            'bit_vector': 2,        'file_open_kind': 2,
            'file_open_status': 2,  'std_ulogic': 2,        'std_ulogic_vector': 2,
            'std_logic': 2,         'std_logic_vector': 2,  'unsigned': 1,
