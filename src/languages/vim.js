  ...
  return {
    ...
    keywords: {
      keyword: //ex command
        ...
        'so spelld spe spelli spellr spellu spellw sp spr sre st sta startg startr star stopi stj sts sun sunm sunme sus sv sw sy synti sync t tN tabN tabc tabdo tabe tabf tabfir tabl tabm tabnew '+
        'tabn tabo tabp tabr tabs tab ta tags tc tcld tclf te tf th tj tl tm tn to tp tr try ts tu u undoj undol una unh unl unlo unm unme uns up v ve verb vert vim vimgrepa vi viu vie vm vmapc vme vne vn vnoreme vs vu vunme windo w wN wa wh wi winc winp wn wp wq wqa ws wu wv x xa xmapc xm xme xn xnoreme xu xunme y z ~ '+
        // full version
