...
export default function(hljs) {
  ...
  const KEYWORDS = [
    'break', 'breakWith', 'breakOut', 'breakTo',
    'case', 'catch', 'continue', 'continueWith',
    'default', 'do',
    'else', 'exit', 'exitWith',
    'for', 'forEach', 'from',
    'if',
  ...
  const LITERAL = [
    ...
    'pi',
    'resistance',
    'scriptNull', 'sideAmbientLife', 'sideEmpty', 'sideLogic', 'sideUnknown', 'sideEnemy', 'sideFriendly',
