...
Несмотря на то, что highlight.pack.js уже содержит только те языки, которые вы
собираетесь использовать, иногда возникает нужда еще больше оганичить набор языков,
используемых на странице. Это достигается перечислением их имен при инициализации:
