...
[![Build CI](https://github.com/highlightjs/highlight.js/workflows/Node.js%20CI/badge.svg)](https://github.com/highlightjs/highlight.js/actions?query=workflow%3A%22Node.js+CI%22) [![Known Vulnerabilities](https://snyk.io/test/github/highlightjs/highlight.js/badge.svg?targetFile=package.json)](https://snyk.io/test/github/highlightjs/highlight.js?targetFile=package.json) [![install size](https://packagephobia.now.sh/badge?p=highlight.js)](https://packagephobia.now.sh/result?p=highlight.js)
